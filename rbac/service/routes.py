...
from django.urls import URLPattern, URLResolver, ResolverMatch,  LocalePrefixPattern
        ...
        if isinstance(item, URLResolver):
            ...
            if pre_namespace:
                ...
                if item.namespace:
                    ...
                    namespace = None
            recursion_urls(namespace, pre_url + str(item).split("'")[-2], item.url_patterns, url_ordered_dict)
