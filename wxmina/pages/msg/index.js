...
Page({
        ...
        wx.request({
            ...
            success: function(res){
                ...
                if(msglist.length == 0){
                    ...
                    that.setData({
                        msglist: that.data.msglist.concat(msglist),
                        noMsg: false
                    })
                }
                wx.hideTabBarRedDot({
                ...
                that.comment_wxparse(msglist, "msgArray")
            }
        })
    },
    comment_wxparse: function (event, type) {
        ...
        for (let i = 0; i < event.length; i++) {
            var content = "<p>" + event[i].describe + "</p >"
            wxparse.wxParse('reply' + i, 'html', event[i].describe, this)
